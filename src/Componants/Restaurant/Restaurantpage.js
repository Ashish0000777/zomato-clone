...
function Restaurantpage() {
  ...
  let getRestaurant = async () => {
    try {
      let url = "https://zomato-be.onrender.com/api/get-Restaurant-by-id/" + id;
  ...
  let getMenuItems = async () => {
    try {
      let url =
        "https://zomato-be.onrender.com/api/get-menu-items-by-restaurant-id/" + id;
      let { data } = await axios.get(url);
      console.log(data);
      if (data.status === true) {
  ...
  let Display_Razorpay = async () => {
    ...
    let url = "https://zomato-be.onrender.com/api/payment/gen-order";
    ...
    var options = {
      ...
      handler: async function (response) {
        ...
        let url = "https://zomato-be.onrender.com/api/payment/verify";
